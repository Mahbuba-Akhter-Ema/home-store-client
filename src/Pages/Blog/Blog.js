    ...
    return (
        <section className="dark:bg-gray-800 dark:text-gray-100">
            <div className="container flex flex-col justify-center px-4 py-8 mx-auto md:p-8">
                ...
                <p className="mt-4 mb-8 dark:text-gray-400">Learn More About Web Development</p>
                <div className="space-y-4">
                    <details className="w-full border rounded-lg">
                        ...
                        <p className="px-4 py-6 pt-0 ml-4 -mt-4 dark:text-gray-400">The Four Kinds of React State to Manage: Local state. Global state. Server state. URL state.</p>
                    </details>
                    <details className="w-full border rounded-lg">
